...
public class CharacterTemplate : ScriptableObject {
    ...
    [Tooltip("如果默认普通攻击为法术，可在此指定备用戏法/法术数据（用于法术普通攻击的伤害与类型）")]
    ...
    /// <summary>
        ...
        public bool proficientSpellAttacks;
